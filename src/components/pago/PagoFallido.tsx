      ...
      <div className="card mx-auto w-full max-w-lg bg-white shadow-2xl">
        <div className="card-body items-center text-center">
          <div className="bg-error/10 mb-4 rounded-full p-6">
            <CircleX className="text-error h-16 w-16" />
          </div>
          <h1 className="card-title text-2xl">Pago Rechazado</h1>
          <p className="text-base-content/70">
            Tu pago no pudo ser procesado. No se realizó ningún cargo. Puedes intentar nuevamente
            desde tus reservas.
          </p>
