...
export function ReservationsCalendar({
      ...
      <div className="card bg-white shadow-xl border">
        <div className="card-body">
          ...
          <p className="text-sm text-base-content/70 mb-4">
            Tienes {selectedReservations?.length || 0} reserva{selectedReservations?.length !== 1 ? "s" : ""}{" "}
            este día.
          </p>

          <div className="space-y-3 max-h-[40vh] overflow-y-auto">
            {(!selectedReservations || selectedReservations.length === 0) && (
              <div className="p-4 text-base-content/70 text-center">No se encontraron reservas para este día.</div>
            )}
            ...
            {selectedReservations?.map((reservation: any) => {
              ...
              return (
                <div key={reservation.id} className="card bg-white shadow-sm border p-3">
                  <div className="flex items-start justify-between mb-2">
                    <div className="flex-1">
                      <h4 className="text-sm font-semibold text-base-content mb-0.5">{courseTitle}</h4>
                      {classTitle && <div className="text-xs text-base-content/70">Class: {classTitle}</div>}
                      <p className="text-xs text-base-content/70">Instructor: {instructor}</p>
                    </div>
                  ...
                  <div className="text-xs text-base-content/70">Status: {status}</div>
  ...
  return (
    <section className="bg-base-100 p-6 rounded-lg border-2 border-black">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-base-content mb-2">Mis Reservas</h2>
          ...
          <div className="card bg-white shadow-xl border">
            <div className="card-body p-6">
                      ...
                      className={`
                        ...
                        ${
                          isSelected
                            ...
                            : "bg-gray-100 text-base-content hover:bg-gray-200"
                        }
              ...
              <div className="mt-6 flex items-center gap-4 text-sm text-base-content/70">
                ...
                <div className="flex items-center gap-2">
                  <div className="w-4 h-4 rounded ring-2 ring-accent ring-offset-2 ring-offset-white bg-gray-100" />
                  <span>Hoy</span>
                </div>
                <div className="flex items-center gap-2">
